...
mixin _$PokemonDetailsState {
  ...
  PokemonModel? get pokemonModel => throw _privateConstructorUsedError;
...
abstract class $PokemonDetailsStateCopyWith<$Res> {
  ...
  @useResult
  $Res call({PokemonStatus status, PokemonModel? pokemonModel});
...
class _$PokemonDetailsStateCopyWithImpl<$Res, $Val extends PokemonDetailsState>
    ...
    return _then(_value.copyWith(
      status: null == status
          ...
          : status // ignore: cast_nullable_to_non_nullable
              as PokemonStatus,
      pokemonModel: freezed == pokemonModel
          ? _value.pokemonModel
  ...
  @pragma('vm:prefer-inline')
  $PokemonModelCopyWith<$Res>? get pokemonModel {
    if (_value.pokemonModel == null) {
      return null;
    }

    return $PokemonModelCopyWith<$Res>(_value.pokemonModel!, (value) {
      return _then(_value.copyWith(pokemonModel: value) as $Val);
    });
  }
}
...
class _$_PokemonDetailsState implements _PokemonDetailsState {
  const _$_PokemonDetailsState({required this.status, this.pokemonModel});
  ...
  @override
  String toString() {
    return 'PokemonDetailsState(status: $status, pokemonModel: $pokemonModel)';
  }
  ...
  @override
  int get hashCode => Object.hash(runtimeType, status, pokemonModel);
...
abstract class _PokemonDetailsState implements PokemonDetailsState {
  const factory _PokemonDetailsState(
      {required final PokemonStatus status,
      final PokemonModel? pokemonModel}) = _$_PokemonDetailsState;
