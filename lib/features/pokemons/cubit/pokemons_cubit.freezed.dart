...
class __$$_PokemonsStateCopyWithImpl<$Res>
    extends _$PokemonsStateCopyWithImpl<$Res, _$_PokemonsState>
...
class _$_PokemonsState implements _PokemonsState {
  ...
  @override
  String toString() {
    return 'PokemonsState(status: $status, hasReachedMax: $hasReachedMax, pokemons: $pokemons)';
  }
...
abstract class _PokemonsState implements PokemonsState {
  const factory _PokemonsState(
      ...
      final bool? hasReachedMax,
      final List<PokemonModel>? pokemons}) = _$_PokemonsState;
